...
create_sides()
create_align()
create_pillar(space, (75,800))
create_pillar(space, (125,800))
create_pillar(space, (175,800))
create_pillar(space, (225,800))
create_pillar(space, (275,800))
create_pillar(space, (325,800))
create_pillar(space, (375,800))
create_pillar(space, (425,800))
create_pillar(space, (475,800))
create_pillar(space, (525,800))
create_pillar(space, (575,800))
create_pillar(space, (625,800))
create_pillar(space, (675,800))
create_pillar(space, (725,800))

for i in range(0,1000):
    if(i%2 == 0):
        fballs.append(create_falling_balls(space,(400,20)))
    else: 
        fballs.append(create_falling_balls(space,(400, -1000)))
balls = []
for i in range(0,26):
...
board = []
board.append(create_board(space))
